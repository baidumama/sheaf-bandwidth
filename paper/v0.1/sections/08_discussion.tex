...
recorded in \cref{tab:6-evidence} examines $32$ sampling
configurations at base scale $N \approx 300$; the multi-$N$ scan
($N \in \{300, 1000, 3000, 5000\}$) shows a stable ordering---the top
three configurations (Cartesian, random, sparkling) sit above the
bottom two (spiral, radial) at every $N$---with the separation in the
singular value ratio widening from under one order of magnitude at
$N \approx 300$ to several orders by $N \approx 5000$.
